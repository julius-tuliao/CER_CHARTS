...
<?php include "partials/panel.php"; ?>
			...
			<div class="branchChart">	
				<h3 align="center" id="title">SPM Collection Bank</h3>  
				<div class="row">

					<a class="btn btn-primary" href="stillChartBankPlacement.php">Prev</a>
					<a class="btn btn-primary" href="stillChartBankBranch.php">Next</a>
